...
This page documents the tools available for managing newmindflow workflow executions.

## Overview

Execution tools allow AI assistants to execute newmindflow workflows and manage execution records. These tools provide a natural language interface to newmindflow's execution capabilities, allowing workflows to be run, monitored, and their results accessed.
...
| Server Error | An unexpected error occurred on the newmindflow server |
