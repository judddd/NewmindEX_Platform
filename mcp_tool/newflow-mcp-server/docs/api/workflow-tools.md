...
This page documents the tools available for managing newmindflow workflows.

## Overview

Workflow tools allow AI assistants to manage newmindflow workflows, including creating, retrieving, updating, deleting, activating, and deactivating workflows. These tools provide a natural language interface to newmindflow's workflow management capabilities.
