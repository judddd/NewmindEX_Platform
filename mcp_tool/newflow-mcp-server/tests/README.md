# Testing System for newmindflow MCP Server

This directory contains the testing framework and tests for the newmindflow MCP Server project. The tests are organized in a hierarchical structure to match the project's architecture.
...
- **mocks/newmindflow-fixtures.ts**: Mock data for newmindflow API responses
