...
show_installation_plan() {
    ...
    echo -e "${BLUE}║${NC}   ${GREEN}2.${NC} Node.js 22 (LTS) + UV"
    echo -e "${BLUE}║${NC}   ${GREEN}3.${NC} LM Studio"
    echo -e "${BLUE}║${NC}   ${GREEN}4.${NC} NewChat"
    echo -e "${BLUE}║${NC}   ${GREEN}5.${NC} AI模型 (手动下载)"
    echo -e "${BLUE}║${NC}   ${GREEN}6.${NC} Docker镜像 (ES, Kibana, MCP)"
    echo -e "${BLUE}║${NC}   ${GREEN}7.${NC} 本地模块 (NewRag, NewFlow)"
    echo -e "${BLUE}║${NC}   ${GREEN}8.${NC} Python环境和依赖"
    echo -e "${BLUE}║${NC}   ${GREEN}9.${NC} 启动所有服务"
    echo -e "${BLUE}║${NC}"
    echo -e "${BLUE}║${NC} ${YELLOW}预计安装时间: 15-25分钟${NC}"
    echo -e "${BLUE}║${NC} ${YELLOW}所需磁盘空间: ~20GB${NC}"
    echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
    echo ""
}
