...
export class WorkflowsController {
	...
	async create(req: WorkflowRequest.Create) {
		...
		if (this.license.isSharingEnabled()) {
			...
			// Credential permission validation is skipped for now
			// TODO: Implement basic credential access check if needed
		...
		// Enterprise workflow service has been removed
		const savedWorkflowWithMetaData = savedWorkflow;
	...
	async getWorkflow(req: WorkflowRequest.Get) {
		...
		if (this.license.isSharingEnabled()) {
			...
			// Enterprise workflow service has been removed
			// Returning basic workflow without owner/sharing metadata
			const workflowWithMetaData = workflow;
	...
	async update(req: WorkflowRequest.Update) {
		...
		// Enterprise workflow service has been removed
		// Credential tampering prevention is skipped
		// TODO: Implement basic credential ownership check if needed
	...
	async runManually(
		...
		if (this.license.isSharingEnabled()) {
			...
			// Enterprise workflow service has been removed
			// Credential tampering prevention is skipped
			// Using workflow nodes as-is without enterprise validation
			req.body.workflowData.nodes = workflow.nodes;
		}
	...
	async share(req: WorkflowRequest.Share) {
		...
		await dbManager.transaction(async (trx) => {
			...
			// Enterprise workflow service has been removed
			// Project sharing functionality is no longer available
			// TODO: Implement basic workflow sharing if needed
	...
	async transfer(
		...
		// Enterprise workflow service has been removed
		// Workflow transfer functionality is no longer available
		throw new BadRequestError('Workflow transfer is not available in this version');
	}
