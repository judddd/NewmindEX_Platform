...
import type { AuthenticationMethod, ProjectRelation } from '@newflow/api-types';
import type { AuthProviderType, User, IWorkflowDb } from '@newflow/db';
import type {
...
export type RelayEventMap = {
	...
	// NewFlow: External Secrets feature has been removed
	// #endregion
