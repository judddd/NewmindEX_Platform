...
import type { CredentialsEntity, SharedCredentials, User } from '@newflow/db';
import { CredentialsRepository, SharedCredentialsRepository } from '@newflow/db';
import { Service } from '@newflow/di';
import { hasGlobalScope } from '@newflow/permissions';
import type { CredentialSharingRole, ProjectRole, Scope } from '@newflow/permissions';
