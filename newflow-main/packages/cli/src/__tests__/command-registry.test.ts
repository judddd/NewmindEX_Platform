...
import type { Logger, ModuleRegistry } from '@newflow/backend-common';
import { CliParser } from '@newflow/backend-common';
import { CommandMetadata } from '@newflow/decorators';
