...
export class InsightsConfig {
	 ...
	 * Default: 60
	 */
	@Env('NEWFLOW_INSIGHTS_COMPACTION_INTERVAL_MINUTES')
	 ...
	 * Default: 500
	 */
	@Env('NEWFLOW_INSIGHTS_COMPACTION_BATCH_SIZE')
	 ...
	 * Default: 90
	 */
	@Env('NEWFLOW_INSIGHTS_COMPACTION_HOURLY_TO_DAILY_THRESHOLD_DAYS')
	 ...
	 * Default: 180
	 */
	@Env('NEWFLOW_INSIGHTS_COMPACTION_DAILY_TO_WEEKLY_THRESHOLD_DAYS')
	 ...
	 * Default: 1000
	 */
	@Env('NEWFLOW_INSIGHTS_FLUSH_BATCH_SIZE')
	 ...
	 * Default: 30
	 */
	@Env('NEWFLOW_INSIGHTS_FLUSH_INTERVAL_SECONDS')
	 ...
	 */
	@Env('NEWFLOW_INSIGHTS_MAX_AGE_DAYS')
	maxAgeDays: number = -1;
	 ...
	 * Default: 24
	 */
	@Env('NEWFLOW_INSIGHTS_PRUNE_CHECK_INTERVAL_HOURS')
