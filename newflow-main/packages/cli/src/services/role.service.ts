...
import { CreateRoleDto, UpdateRoleDto } from '@newflow/api-types';
import { LicenseState } from '@newflow/backend-common';
import {
	CredentialsEntity,
	SharedCredentials,
	SharedWorkflow,
...
export class RoleService {
	 ...
	 * This replaces the original rolesWithScope function from @newflow/permissions
	 */
	...
	isRoleLicensed(role: string | AssignableProjectRole) {
