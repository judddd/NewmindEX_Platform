...
import type { RoleChangeRequestDto } from '@newflow/api-types';
import { Logger } from '@newflow/backend-common';
import type { PublicUser } from '@newflow/db';
import { User, UserRepository } from '@newflow/db';
import { Service } from '@newflow/di';
import { getGlobalScopes, type AssignableGlobalRole } from '@newflow/permissions';
