...
export const ENV_VARS_DOCS_URL = 'http://newflow.ee/reference/environment-variables.html';

export const DB_QUERY_PARAMS_DOCS_URL =
	'http://newflow.ee/integrations/builtin/app-nodes/n8n-nodes-base.postgres#use-query-parameters';

export const COMMUNITY_NODES_RISKS_URL = 'http://newflow.ee/integrations/community-nodes/risks';
