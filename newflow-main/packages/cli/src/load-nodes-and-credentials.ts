...
import { inTest, isContainedWithin, Logger, ModuleRegistry } from '@newflow/backend-common';
...
export class LoadNodesAndCredentials {
	...
	async init() {
		...
		for (const nodeModulesDir of basePathsToScan) {
			...
			await this.loadNodesFromNodeModules(nodeModulesDir, '@newflow/n8n-nodes-langchain');
		}
