...
import { CreateProjectDto, DeleteProjectDto, UpdateProjectDto } from '@newflow/api-types';
import type { Project } from '@newflow/db';
import { AuthenticatedRequest, ProjectRepository } from '@newflow/db';
import {
	Get,
	Post,
	GlobalScope,
...
import { combineScopes, getAuthPrincipalScopes, hasGlobalScope } from '@newflow/permissions';
