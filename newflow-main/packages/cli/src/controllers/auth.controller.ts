...
import { LoginRequestDto, ResolveSignupTokenQueryDto } from '@newflow/api-types';
import { Logger } from '@newflow/backend-common';
import type { User, PublicUser } from '@newflow/db';
import { UserRepository, AuthenticatedRequest, GLOBAL_OWNER_ROLE } from '@newflow/db';
...
export class AuthController {
	...
	async login(
		...
		// NewFlow: Only email/password authentication is supported (SSO removed)
		if (!isEmail(emailOrLdapLoginId)) {
