...
import { UserRepository, AuthenticatedRequest } from '@newflow/db';
import { Body, Patch, Post, RestController } from '@newflow/decorators';
...
export class MeController {
	...
	async updateCurrentUser(
		...
		// NewFlow: SSO checks removed - all users can update their profile
