...
import { ExecutionRepository } from '@newflow/db';
 ...
 * [Resume On Webhook Call](http://newflow.ee/integrations/builtin/core-nodes/n8n-nodes-base.wait/#on-webhook-call)
 * feature.
 */
@Service()
export class WaitingWebhooks implements IWebhookManager {
	...
	validateSignatureInRequest(req: express.Request) {
		try {
			...
			// as long as NEWFLOW_PROXY_HOPS is set correctly
