...
import { EventDestinationsRepository, ExecutionRepository, WorkflowRepository } from '@newflow/db';
...
export class MessageEventBus extends EventEmitter {
	...
	async addDestination(destination: any, notifyWorkers: boolean = true) {
