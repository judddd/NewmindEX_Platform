...
import { CliParser, Logger, ModuleRegistry } from '@newflow/backend-common';
import { CommandMetadata, type CommandEntry } from '@newflow/decorators';
...
export class CommandRegistry {
	...
	async listAllCommands() {
		...
		this.logger.info(
			'\nFor more detailed information, visit:\nhttp://newflow.ee/hosting/cli-commands/',
		);
	}
