...
import type { User, ExecutionSummaries } from '@newflow/db';
import { Get, Patch, Post, RestController } from '@newflow/decorators';
import { PROJECT_OWNER_ROLE_SLUG, type Scope } from '@newflow/permissions';
...
export class ExecutionsController {
	...
	async getOne(req: ExecutionRequest.GetOne) {
		...
		// Enterprise execution service has been removed - using base service
