import type { ApiKeyWithRawValue } from '@newflow/api-types';
import { testDb, randomValidPassword, mockInstance } from '@newflow/backend-test-utils';
import { GlobalConfig } from '@newflow/config';
import type { User } from '@newflow/db';
import { ApiKeyRepository, GLOBAL_MEMBER_ROLE, GLOBAL_OWNER_ROLE } from '@newflow/db';
