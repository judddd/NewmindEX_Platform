import { LicenseState, ModuleRegistry } from '@newflow/backend-common';
import { mockInstance, mockLogger, testModules, testDb } from '@newflow/backend-test-utils';
import { GlobalConfig } from '@newflow/config';
import type { APIRequest, User } from '@newflow/db';
		...
		if (endpointGroups.length) {
			for (const group of endpointGroups) {
				switch (group) {
					...
					// NewFlow: evaluation controller removed
