import { randomName, mockInstance } from '@newflow/backend-test-utils';
import type { WorkflowEntity } from '@newflow/db';
import { generateNanoId, WorkflowRepository } from '@newflow/db';
