...
export class ChatTrigger extends Node {
	description: INodeTypeDescription = {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'http://newflow.ee/integrations/builtin/core-nodes/n8n-nodes-langchain.chattrigger/',
					},
				],
			},
		},
		...
		properties: [
			...
			{
				displayName:
					'Follow the instructions <a href="https://www.npmjs.com/package/@newflow/chat" target="_blank">here</a> to embed chat in a webpage (or just call the webhook URL at the top of this section). Chat will be live once you activate this workflow',
