	...
	constructor(baseDescription: INodeTypeBaseDescription) {
		this.description = {
			...
			properties: [
				{
					displayName:
						'Tip: Get a feel for agents with our quick <a href="http://newflow.ee/advanced-ai/intro-tutorial/" target="_blank">tutorial</a> or see an <a href="/workflows/templates/1954" target="_blank">example</a> of how this node works',
