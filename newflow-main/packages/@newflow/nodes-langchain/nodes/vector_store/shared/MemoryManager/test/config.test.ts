...
describe('Vector Store Config', () => {
	...
	describe('getConfig', () => {
		it('should return default values when no environment variables set', () => {
			...
			delete process.env.NEWFLOW_VECTOR_STORE_MAX_MEMORY;
			delete process.env.NEWFLOW_VECTOR_STORE_TTL_HOURS;
		...
		it('should use values from environment variables when set', () => {
			process.env.NEWFLOW_VECTOR_STORE_MAX_MEMORY = '200';
			process.env.NEWFLOW_VECTOR_STORE_TTL_HOURS = '24';
		...
		it('should handle invalid environment variable values', () => {
			...
			process.env.NEWFLOW_VECTOR_STORE_MAX_MEMORY = 'invalid';
			process.env.NEWFLOW_VECTOR_STORE_TTL_HOURS = 'notanumber';
