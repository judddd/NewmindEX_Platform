...
class HealthConfig {
	...
	@Env('NEWFLOW_WORKER_SERVER_ADDRESS')
	address: string = '::';
}
...
class BullConfig {
	...
	/** @deprecated How long (in seconds) a worker must wait for active executions to finish before exiting. Use `NEWFLOW_GRACEFUL_SHUTDOWN_TIMEOUT` instead */
