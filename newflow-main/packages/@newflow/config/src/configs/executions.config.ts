...
class QueueRecoveryConfig {
	...
	@Env('NEWFLOW_EXECUTIONS_QUEUE_RECOVERY_INTERVAL')
	interval: number = 180;

	/** Size of batch of executions to check for queue recovery. */
	@Env('NEWFLOW_EXECUTIONS_QUEUE_RECOVERY_BATCH')
