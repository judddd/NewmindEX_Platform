...
export const ACTION_RECORDED_PAGE = `
	...
	<head>
		...
		<link rel='icon' type='image/png' href='http://newflow.ee/favicon.ico' />
		<link
	...
	<body>
		<div class='container'>
			<section>
				...
				<div class='n8n-link'>
					<a
						href='http://newflow.ee/?utm_source=n8n-internal&amp;utm_medium=send-and-wait'
						target='_blank'
					>
						Automated with
						<svg
...
export function createEmailBodyWithN8nAttribution(
	...
	const n8nWebsiteLink = `http://newflow.ee/?utm_source=n8n-internal&utm_medium=send-and-wait${utm_campaign}`;
	return `
<!DOCTYPE html>
<html lang='en'>
