...
export const optionsCollection: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			description:
				'Comma-separated list of the values you want to use as query parameters. You can drag the values from the input panel on the left. <a href="http://newflow.ee/integrations/builtin/app-nodes/n8n-nodes-base.mysql/" target="_blank">More info</a>',
		...
		},
		{
			...
			description:
				'Choose from the list, or specify IDs using an <a href="http://newflow.ee/code/expressions/" target="_blank">expression</a>',
			typeOptions: {
			...
			values: [
				{
					...
					description:
						'Choose from the list, or specify an ID using an <a href="http://newflow.ee/code/expressions/" target="_blank">expression</a>',
					default: '',
					placeholder: 'e.g. ID',
					typeOptions: {
