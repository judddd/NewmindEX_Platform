		...
		options: [
			{
				...
				description:
					'Whether to include the phrase "This email was sent automatically with NewFlow" to the end of the email',
			},
			{
	...
	for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
		try {
			...
			if (appendAttribution) {
				const attributionText = 'This email was sent automatically with NewFlow';
