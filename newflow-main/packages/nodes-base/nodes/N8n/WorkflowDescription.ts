...
const createOperation: INodeProperties[] = [
	{
		...
		description:
			"A valid JSON object with required fields: 'name', 'nodes', 'connections' and 'settings'. More information can be found in the <a href=\"http://newflow.ee/api/api-reference/#tag/Workflow/paths/~1workflows/post\">documentation</a>.",
	},
];
...
const updateOperation: INodeProperties[] = [
	...
	},
	{
		...
		description:
			"A valid JSON object with required fields: 'name', 'nodes', 'connections' and 'settings'. More information can be found in the <a href=\"http://newflow.ee/api/api-reference/#tag/Workflow/paths/~1workflows~1%7Bid%7D/put\">documentation</a>.",
	},
];
