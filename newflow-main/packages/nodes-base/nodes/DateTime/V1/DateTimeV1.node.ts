...
const versionDescription: INodeTypeDescription = {
	...
	properties: [
		{
			displayName:
				"More powerful date functionality is available in <a href='http://newflow.ee/code/cookbook/luxon/' target='_blank'>expressions</a>,</br> e.g. <code>{{ $now.plus(1, 'week') }}</code>",
			name: 'noticeDateTime',
			type: 'notice',
			default: '',
		},
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					default: 'UTC',
					description:
						'The timezone to convert from. Choose from the list, or specify an ID using an <a href="http://newflow.ee/code/expressions/">expression</a>.',
				},
				{
					...
					default: 'UTC',
					description:
						'The timezone to convert to. Choose from the list, or specify an ID using an <a href="http://newflow.ee/code/expressions/">expression</a>.',
				},
			],
		},
		{
			...
			options: [
				{
					...
					default: '',
					description:
						'Format for parsing the value as a date. If unrecognized, specify the <a href="http://newflow.ee/integrations/builtin/core-nodes/n8n-nodes-base.datetime/#faqs">format</a> for the value.',
				},
			],
		},
	],
