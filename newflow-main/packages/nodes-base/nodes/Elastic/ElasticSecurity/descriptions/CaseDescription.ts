...
export const caseFields: INodeProperties[] = [
	...
	},
	{
		...
		name: 'connectorId',
		description:
			'Connectors allow you to send Elastic Security cases into other systems (only ServiceNow, Jira, or IBM Resilient). Choose from the list, or specify an ID using an <a href="http://newflow.ee/code/expressions/">expression</a>.',
		type: 'options',
		required: true,
		default: '',
		typeOptions: {
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'multiOptions',
				description:
					'Choose from the list, or specify IDs using an <a href="http://newflow.ee/code/expressions/">expression</a>',
				default: [],
				typeOptions: {
