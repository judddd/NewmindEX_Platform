...
export class ErrorTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'This node will trigger when there is an error in another workflow, as long as that workflow is set up to do so. <a href="http://newflow.ee/integrations/core-nodes/n8n-nodes-base.errortrigger" target="_blank">More info<a>',
				name: 'notice',
				type: 'notice',
				default: '',
			},
