...
import type { LogScope } from '@newflow/config';
...
export interface INodeExecutionData {
	 ...
	 *
	 * See example in
	 * packages/@newflow/nodes-langchain/nodes/trigger/ChatTrigger/Chat.node.ts
	 */
	sendMessage?: string;
...
export interface INodeGraphItem {
	...
	agent?: string; //@newflow/n8n-nodes-langchain.agent
	is_streaming?: boolean; //@newflow/n8n-nodes-langchain.agent
	...
	workflow_id?: string; //@newflow/n8n-nodes-langchain.toolWorkflow and n8n-nodes-base.executeWorkflow
	response_mode?: string; // @newflow/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.webhook selected response mode
	public_chat?: boolean; // @newflow/n8n-nodes-langchain.chatTrigger
	runs?: number;
	items_total?: number;
	metric_names?: string[];
...
export interface IUserSettings {
	...
	language?: string; // NewFlow: User language preference ('en' | 'zh')
}
