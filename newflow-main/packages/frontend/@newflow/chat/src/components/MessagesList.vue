...
import { N8nIcon, N8nText } from '@newflow/design-system';
import { ref, watch } from 'vue';

import Message from '@newflow/chat/components/Message.vue';
import MessageTyping from '@newflow/chat/components/MessageTyping.vue';
import { useChat } from '@newflow/chat/composables';
import type { ChatMessage } from '@newflow/chat/types';
