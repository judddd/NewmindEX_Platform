...
import GetStarted from '@newflow/chat/components/GetStarted.vue';
import GetStartedFooter from '@newflow/chat/components/GetStartedFooter.vue';
import Input from '@newflow/chat/components/Input.vue';
import Layout from '@newflow/chat/components/Layout.vue';
import MessagesList from '@newflow/chat/components/MessagesList.vue';
import { useI18n, useChat, useOptions } from '@newflow/chat/composables';
import { chatEventBus } from '@newflow/chat/event-buses';
