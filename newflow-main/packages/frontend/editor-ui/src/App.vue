...
import { N8nResizeWrapper } from '@newflow/design-system';
...
import { locale } from '@newflow/design-system';
import { setLanguage } from '@newflow/i18n';
...
function onAssistantResize(data: { direction: string; x: number; width: number }) {
...
<template>
	...
	>
		...
		<SlideTransition>
			...
			>
				<div :style="{ width: `${assistantSidebarWidth}px` }" :class="$style.assistantWrapper">
					<AskAssistantChat @close="assistantStore.closeChat" />
				</div>
			</N8nResizeWrapper>
		</SlideTransition>
