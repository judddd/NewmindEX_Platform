...
import { ROLE, type Role, type UsersList } from '@newflow/api-types';
...
import type {
	TableHeader,
	TableOptions,
} from '@newflow/design-system/components/N8nDataTableServer';
...
import type { UsersInfoProps } from '@newflow/design-system/components/N8nUserInfo/UserInfo.vue';
