...
const commonCode = computed(() => ({
	import: `${importCode} '@newflow/chat/style.css';
${importCode} { createChat } from '@newflow/chat';`,
	createChat: `createChat({
	webhookUrl: '${webhookUrl.value}'
});`,
	install: 'npm install @newflow/chat',
}));

const cdnCode = computed(
	() => `<link href="https://cdn.jsdelivr.net/npm/@newflow/chat/dist/style.css" rel="stylesheet" />
<script type="module">
${importCode} { createChat } from 'https://cdn.jsdelivr.net/npm/@newflow/chat/dist/chat.bundle.es.js';
