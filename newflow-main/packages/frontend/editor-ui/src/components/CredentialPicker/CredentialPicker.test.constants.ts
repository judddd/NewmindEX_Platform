...
export const TEST_CREDENTIAL_TYPES: ICredentialTypeMap = {
	openAiApi: {
		...
		supportedNodes: [
			...
			'@newflow/n8n-nodes-langchain.embeddingsOpenAi',
			'@newflow/n8n-nodes-langchain.lmChatOpenAi',
			'@newflow/n8n-nodes-langchain.lmOpenAi',
		],
	},
	supabaseApi: {
		name: 'supabaseApi',
	...
	slackOAuth2Api: {
		...
		properties: [
			...
			{
				displayName:
					'If you get an Invalid Scopes error, make sure you add the correct one <a target="_blank" href="http://newflow.ee/integrations/builtin/credentials/slack/#using-oauth">here</a> to your Slack integration',
				name: 'notice',
				type: 'notice',
				default: '',
			},
