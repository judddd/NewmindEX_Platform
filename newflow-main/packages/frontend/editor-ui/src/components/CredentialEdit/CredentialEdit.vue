...
// import CredentialSharing from '@/components/CredentialEdit/CredentialSharing.ee.vue'; // Removed: Enterprise Edition feature
...
import { N8nInlineTextEdit, N8nText, type IMenuItem } from '@newflow/design-system';
import { getResourcePermissions } from '@newflow/permissions';
import { assert } from '@newflow/utils/assert';
		...
		<template #content>
			<div :class="$style.container" data-test-id="credential-edit-dialog">
				...
				<div v-else-if="showSharingContent" :class="$style.mainContent">
					<!-- CredentialSharing component removed: Enterprise Edition feature -->
					<N8nText color="text-base">
						Credential sharing is not available in this version.
					</N8nText>
				</div>
