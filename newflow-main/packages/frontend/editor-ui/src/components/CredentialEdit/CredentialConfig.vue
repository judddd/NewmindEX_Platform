...
import { useI18n, addCredentialTranslation } from '@newflow/i18n';
import { useTelemetry } from '@/composables/useTelemetry';
import {
	getBuiltinCredentialsDocsUrl,
	DOCS_DOMAIN,
	EnterpriseEditionFeature,
	NEW_ASSISTANT_SESSION_MODAL,
} from '@/constants';
import type { PermissionsRecord } from '@newflow/permissions';
...
import InlineAskAssistantButton from '@newflow/design-system/components/InlineAskAssistantButton/InlineAskAssistantButton.vue';
...
const documentationUrl = computed(() => {
	...
	if (docUrl.startsWith('https://') || docUrl.startsWith('http://')) {
		...
		else url = new URL(`${getBuiltinCredentialsDocsUrl()}${docUrl}/`);
	}
