...
import { N8nInlineTextEdit } from '@newflow/design-system';
import type { PathItem } from '@newflow/design-system/components/N8nBreadcrumbs/Breadcrumbs.vue';
import { type BaseTextKey, useI18n } from '@newflow/i18n';
	...
	<div :class="$style.container">
		...
		<PushConnectionTracker class="actions">
			...
			<div :class="$style.group">
				...
				<N8nButton
					type="secondary"
					data-test-id="workflow-download-button"
					@click="onDownloadButtonClick"
				>
					{{ i18n.baseText('workflowDetails.download') }}
				</N8nButton>
			</div>
			<div :class="$style.group">
				<SaveButton
