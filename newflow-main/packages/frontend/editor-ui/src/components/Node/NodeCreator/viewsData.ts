...
export function AIView(_nodes: SimplifiedNodeType[]): NodeView {
	...
	const isEvaluationEnabled = false; // NewFlow: Evaluation removed
...
export function TriggerView() {
	const i18n = useI18n();
	// NewFlow: Evaluation removed - evaluationTriggerNode is always null
	const evaluationTriggerNode = null;
