...
import { N8nButton, N8nInput, N8nTooltip } from '@newflow/design-system/components';
...
const isSubmitEnabled = computed(() => {
	return (
		!isEachItemMode.value && prompt.value.length >= ASK_AI_MIN_PROMPT_LENGTH
		// hasExecutionData.value - Removed: Allow code generation without execution data
	);
});
	...
	<div>
		...
		<div :class="$style.inputContainer">
			<div :class="$style.meta">
				...
				/>
				<a href="http://newflow.ee/code-examples/ai-code" target="_blank" :class="$style.help">
