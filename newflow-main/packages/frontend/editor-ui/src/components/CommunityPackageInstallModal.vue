...
import {
	...
	getCommunityNodesInstallationDocsUrl,
	getCommunityNodesRisksDocsUrl,
} from '@/constants';
		...
		<template #content>
			<div :class="[$style.descriptionContainer, 'p-s']">
				<div>
					...
					{{ ' ' }}
					<n8n-link :to="getCommunityNodesInstallationDocsUrl()" @click="onMoreInfoTopClick">
			...
			<div :class="[$style.formContainer, 'mt-m']">
				...
				>
					...
					><br />
					<n8n-link :to="getCommunityNodesRisksDocsUrl()" @click="onLearnMoreLinkClick">{{
						i18n.baseText('generic.moreInfo')
					}}</n8n-link>
				</el-checkbox>
			</div>
