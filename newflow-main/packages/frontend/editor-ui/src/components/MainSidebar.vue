...
import { N8nNavigationDropdown, N8nTooltip, N8nLink, N8nIconButton } from '@newflow/design-system';
...
const mainMenuItems = computed<IMenuItem[]>(() => [
...

	{
		id: 'ai-agents',
		icon: 'robot',
		label: i18n.baseText('mainSidebar.aiAgents'),
		position: 'bottom',
		route: { to: { name: VIEWS.AI_AGENTS } },
		available: true,
	},

	// 模板功能已移除 - 面向企业本地部署
	// Variables模块 - 已隐藏（企业本地部署版本）
	{
		id: 'insights',
	...
	// 			link: {
	// 				href: 'https://docs.newflow.io?utm_source=newflow_app&utm_medium=app_sidebar',
	// 				target: '_blank',
	// 			},
	// 		},
	// 		{
	...
	// 			link: {
	// 				href: 'https://community.newflow.io?utm_source=newflow_app&utm_medium=app_sidebar',
	// 				target: '_blank',
	// 			},
	// 		},
	// 		{
...
const onUserActionToggle = (action: string) => {
	switch (action) {
		case 'logout':
			...
			break;
		case 'settings':
			// Direct navigation to Personal Settings (bypass Usage page redirect)
	...
	>
		...
		<div :class="$style.logo">
				...
				>
					<template #content>
						<I18nT keypath="readOnlyEnv.tooltip" scope="global">
							<template #link>
								<N8nLink
									to="http://newflow.ee/source-control-environments/setup/#step-4-connect-n8n-and-configure-your-instance"
									size="small"
								>
			...
			>
				...
				<!-- NewFlow: Project creation removed -->
...
// 修复Hello World菜单项文字对齐 - 更强力的选择器
:global(#side-menu .n8n-menu-item .el-menu-item) {
...
:global(#side-menu .n8n-menu-item .el-menu-item span) {
	text-align: left !important;
	margin-left: 8px !important;
	flex: 1 !important;
}

:global(#side-menu #hello-world) {
	display: flex !important;
	align-items: center !important;
	justify-content: flex-start !important;
