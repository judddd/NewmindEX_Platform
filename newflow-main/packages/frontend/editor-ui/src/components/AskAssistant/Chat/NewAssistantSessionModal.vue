...
import AssistantIcon from '@newflow/design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from '@newflow/design-system/components/AskAssistantText/AssistantText.vue';
