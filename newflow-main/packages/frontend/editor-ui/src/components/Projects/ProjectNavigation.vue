...
import type { IMenuItem } from '@newflow/design-system/types';
...
<template>
	<div :class="$style.projects">
		<!-- NewFlow: Simplified navigation - only show Home/Workflows -->
		<ElMenu :collapse="props.collapsed" class="home">
			...
			/>
			<!-- NewFlow: Personal Project and Shared menus hidden -->
			<!-- <N8nMenuItem
		...
		<!-- NewFlow: All Projects-related UI removed -->
