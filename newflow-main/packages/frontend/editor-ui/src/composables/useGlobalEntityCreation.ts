...
import { sortByProperty } from '@newflow/utils/sort/sortByProperty';
...
import { updatedIconSet, type IconName } from '@newflow/design-system/components/N8nIcon/icons';
...
export const useGlobalEntityCreation = () => {
	...
	const menu = computed<Item[]>(() => {
		// NewFlow: Projects removed - simplified menu
		// Community
