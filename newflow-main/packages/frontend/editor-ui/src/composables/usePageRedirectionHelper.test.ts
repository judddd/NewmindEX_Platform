...
import * as cloudPlanApi from '@newflow/rest-api-client/api/cloudPlans';
...
describe('usePageRedirectionHelper', () => {
	...
	beforeEach(() => {
		...
		versionStore.initialize({
			...
			endpoint: '',
			infoUrl:
				'http://newflow.ee/release-notes/#n8n1652?utm_source=n8n_app&utm_medium=instance_upgrade_releases',
	...
	test.each([
		[
			...
			'production',
			ROLE.Owner,
			'http://newflow.ee/pricing?utm_campaign=upgrade-api&source=advanced-permissions',
		],
		[
			'default',
			'development',
