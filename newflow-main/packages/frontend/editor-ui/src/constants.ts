...
// Get docs base URL from settings store, with fallback to default
// These functions will be initialized after the settings store is available
let getDocsBaseUrl: () => string = () => 'https://docs.newflow.io';

export function initDocsUrls(docsBaseUrl: string) {
	getDocsBaseUrl = () => docsBaseUrl;
}

export const getBuiltinNodesDocsUrl = () => `${getDocsBaseUrl()}/integrations/builtin/`;
export const getBuiltinCredentialsDocsUrl = () =>
	`${getDocsBaseUrl()}/integrations/builtin/credentials/`;
export const getDataPinningDocsUrl = () => `${getDocsBaseUrl()}/data/data-pinning/`;
export const getDataEditingDocsUrl = () => `${getDocsBaseUrl()}/data/data-editing/`;
export const getSchemaPrevewDocsUrl = () => `${getDocsBaseUrl()}/data/schema-preview/`;
export const getMfaDocsUrl = () => `${getDocsBaseUrl()}/user-management/two-factor-auth/`;
export const getQueueModeDocsUrl = () => `${getDocsBaseUrl()}/hosting/scaling/queue-mode/`;
export const getCommunityNodesInstallationDocsUrl = () =>
	`${getDocsBaseUrl()}/integrations/community-nodes/installation/gui-install/`;
export const getCommunityNodesRisksDocsUrl = () =>
	`${getDocsBaseUrl()}/integrations/community-nodes/risks/`;
export const getCommunityNodesBlocklistDocsUrl = () =>
	`${getDocsBaseUrl()}/integrations/community-nodes/blocklist/`;
export const getCustomNodesDocsUrl = () =>
	`${getDocsBaseUrl()}/integrations/creating-nodes/code/create-n8n-nodes-module/`;
export const getExpressionsDocsUrl = () => `${getDocsBaseUrl()}/code-examples/expressions/`;
export const getErrorWorkflowDocsUrl = () =>
	`${getDocsBaseUrl()}/flow-logic/error-handling/#create-and-set-an-error-workflow`;
export const getTimeSavedDocsUrl = () =>
	`${getDocsBaseUrl()}/insights/#setting-the-time-saved-by-a-workflow`;

// For backward compatibility, export the old constant names as getters
export const DOCS_DOMAIN = 'docs.newflow.io'; // Keep for any direct domain checks
export const BUILTIN_NODES_DOCS_URL = getBuiltinNodesDocsUrl();
export const BUILTIN_CREDENTIALS_DOCS_URL = getBuiltinCredentialsDocsUrl();
export const DATA_PINNING_DOCS_URL = getDataPinningDocsUrl();
export const DATA_EDITING_DOCS_URL = getDataEditingDocsUrl();
export const SCHEMA_PREVIEW_DOCS_URL = getSchemaPrevewDocsUrl();
export const MFA_DOCS_URL = getMfaDocsUrl();
export const NEWFLOW_QUEUE_MODE_DOCS_URL = getQueueModeDocsUrl();
export const COMMUNITY_NODES_INSTALLATION_DOCS_URL = getCommunityNodesInstallationDocsUrl();
export const COMMUNITY_NODES_RISKS_DOCS_URL = getCommunityNodesRisksDocsUrl();
export const COMMUNITY_NODES_BLOCKLIST_DOCS_URL = getCommunityNodesBlocklistDocsUrl();
export const CUSTOM_NODES_DOCS_URL = getCustomNodesDocsUrl();
export const EXPRESSIONS_DOCS_URL = getExpressionsDocsUrl();
export const ERROR_WORKFLOW_DOCS_URL = getErrorWorkflowDocsUrl();
export const TIME_SAVED_DOCS_URL = getTimeSavedDocsUrl();
...
export const NEWFLOW_PRICING_PAGE_URL = 'https://newflow.io/pricing';
export const NEWFLOW_MAIN_GITHUB_REPO_URL = 'https://github.com/newflow-io/newflow';
...
export const AI_CODE_NODE_TYPE = '@newflow/n8n-nodes-langchain.code';
export const AI_MCP_TOOL_NODE_TYPE = '@newflow/n8n-nodes-langchain.mcpClientTool';
export const WIKIPEDIA_TOOL_NODE_TYPE = '@newflow/n8n-nodes-langchain.toolWikipedia';
...
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@newflow/n8n-nodes-langchain.manualChatTrigger';
export const MCP_TRIGGER_NODE_TYPE = '@newflow/n8n-nodes-langchain.mcpTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@newflow/n8n-nodes-langchain.chatTrigger';
export const CHAT_NODE_TYPE = '@newflow/n8n-nodes-langchain.chat';
export const AGENT_NODE_TYPE = '@newflow/n8n-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@newflow/n8n-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@newflow/n8n-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@newflow/n8n-nodes-langchain.openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@newflow/n8n-nodes-langchain.chainLlm';
export const QA_CHAIN_NODE_TYPE = '@newflow/n8n-nodes-langchain.chainRetrievalQa';
export const MICROSOFT_TEAMS_NODE_TYPE = 'n8n-nodes-base.microsoftTeams';
export const NEWFLOW_NODE_TYPE = 'n8n-nodes-base.n8n';
...
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE =
	'@newflow/n8n-nodes-langchain.chainSummarization';
...
> = {
	...
	// ADD_EVALUATION_NODE_BUTTON: 'add_evaluation_node_button', // NewFlow: Evaluation removed
	// ADD_EVALUATION_TRIGGER_BUTTON: 'add_evaluation_trigger_button', // NewFlow: Evaluation removed
...
// NewFlow: Evaluation removed
// export const AI_EVALUATION = 'Evaluation';
export const AI_UNCATEGORIZED_CATEGORY = 'Miscellaneous';
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@newflow/n8n-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@newflow/n8n-nodes-langchain.toolWorkflow';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'NEWFLOW_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'NEWFLOW_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'NEWFLOW_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'NEWFLOW_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_AUTOCOMPLETE_IS_ONBOARDED = 'NEWFLOW_AUTOCOMPLETE_ONBOARDED';
export const LOCAL_STORAGE_TABLE_HOVER_IS_ONBOARDED = 'NEWFLOW_TABLE_HOVER_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'NEWFLOW_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_NDV_DIMENSIONS = 'NEWFLOW_NDV_DIMENSIONS';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'NEWFLOW_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'NEWFLOW_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'NEWFLOW_EXPERIMENT_OVERRIDES';
export const LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON = 'NEWFLOW_HIDE_HIDE_GITHUB_STAR_BUTTON';
export const LOCAL_STORAGE_NDV_INPUT_PANEL_DISPLAY_MODE = 'NEWFLOW_NDV_INPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_NDV_OUTPUT_PANEL_DISPLAY_MODE = 'NEWFLOW_NDV_OUTPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_LOGS_PANEL_OPEN = 'NEWFLOW_LOGS_PANEL_OPEN';
export const LOCAL_STORAGE_TURN_OFF_WORKFLOW_SUGGESTIONS = 'NEWFLOW_TURN_OFF_WORKFLOW_SUGGESTIONS';
export const LOCAL_STORAGE_LOGS_SYNC_SELECTION = 'NEWFLOW_LOGS_SYNC_SELECTION_ENABLED';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = 'NEWFLOW_LOGS_DETAILS_PANEL';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE =
	'NEWFLOW_LOGS_DETAILS_PANEL_SUB_NODE';
export const LOCAL_STORAGE_WORKFLOW_LIST_PREFERENCES_KEY = 'NEWFLOW_WORKFLOWS_LIST_PREFERENCES';
export const LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = 'NEWFLOW_READ_WHATS_NEW_ARTICLES';
export const LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = 'NEWFLOW_DISMISSED_WHATS_NEW_CALLOUT';
export const LOCAL_STORAGE_NDV_PANEL_WIDTH = 'NEWFLOW_NDV_PANEL_WIDTH';
export const LOCAL_STORAGE_FOCUS_PANEL = 'NEWFLOW_FOCUS_PANEL';
export const LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS =
	'NEWFLOW_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS';
export const LOCAL_STORAGE_RUN_DATA_WORKER = 'NEWFLOW_RUN_DATA_WORKER';

export const BASE_NODE_SURVEY_URL = 'https://newflow-community.typeform.com/to/BvmzxqYv#nodename=';
export const COMMUNITY_PLUS_DOCS_URL =
	'https://docs.newflow.io/hosting/community-edition-features/#registered-community-edition';
export const RELEASE_NOTES_URL = 'https://docs.newflow.io/release-notes/';
...
Love n8n? Help us build the future of automation! http://newflow.ee/careers?utm_source=n8n_user&utm_medium=console_output
`;
...
export const enum VIEWS {
	...
	// VARIABLES = 'VariablesView', // NewFlow: Variables removed
	...
	// LDAP_SETTINGS = 'LdapSettings', // NewFlow: SSO removed
	...
	// EVALUATION = 'Evaluation', // NewFlow: Evaluation removed
	// EVALUATION_EDIT = 'EvaluationEdit', // NewFlow: Evaluation removed
	// EVALUATION_RUNS_DETAIL = 'EvaluationRunsDetail', // NewFlow: Evaluation removed
	USAGE = 'Usage',
	// LOG_STREAMING_SETTINGS = 'LogStreamingSettingsView', // NewFlow: Log Streaming removed
	// SSO_SETTINGS = 'SSoSettings', // NewFlow: SSO removed
	// EXTERNAL_SECRETS_SETTINGS = 'ExternalSecretsSettings', // NewFlow: External Secrets removed
	// SAML_ONBOARDING = 'SamlOnboarding', // NewFlow: SSO removed
	// SOURCE_CONTROL = 'SourceControl', // NewFlow: Source Control removed
	MFA_VIEW = 'MfaView',
	WORKFLOW_HISTORY = 'WorkflowHistory',
	// WORKER_VIEW = 'WorkerView', // NewFlow: Worker View removed
	PROJECTS = 'Projects',
...
export const NEWFLOW_SALES_EMAIL = 'sales@newmindtech.cn';

export const NEWFLOW_CONTACT_EMAIL = 'contact@newmindtech.cn';
...
// NewFlow: Stub - no cloud plan page
...
// NewFlow: Stub - no external creator hub
 ...
 */
// NewFlow: Stub - no external templates service
export const TEMPLATES_URLS = {
	DEFAULT_API_HOST: '',
	BASE_WEBSITE_URL: 'http://newflow.ee/workflows/',
	UTM_QUERY: {
		utm_source: 'newflow_app',
...
<div style="font-size: 18px; max-width: 640px; text-align: left; margin: 10px auto">
	...
	<ul>
		...
		<li>If you prefer to disable this security feature (<strong>not recommended</strong>), set the environment variable <code>NEWFLOW_SECURE_COOKIE</code> to <code>false</code></li>
	</ul>
</div>
</body>`;
...
export const AI_NODES_PACKAGE_NAME = '@newflow/n8n-nodes-langchain';
