	...
	return variables.map((variable) =>
		createCompletionOption({
			...
			doc: {
				...
				docURL: 'http://newflow.ee/environments/variables/',
			},
		}),
	);
};
	...
	return [
		{
			name: 'statusCode',
			returnType: 'number',
			docURL: 'http://newflow.ee/code/builtin/http-node-variables/',
...
export const executionOptions = () => {
	return [
...

		{
			name: 'resumeUrl',
			returnType: 'string',
			docURL: 'http://newflow.ee/integrations/builtin/core-nodes/n8n-nodes-base.wait/',
		...
		},
		{
			...
			docURL: 'http://newflow.ee/workflows/executions/custom-executions-data/',
	...
	const options: Array<{ doc: DocMetadata; isFunction?: boolean }> = [
		{
			doc: {
				name: 'item',
				returnType: 'Item',
				docURL: 'http://newflow.ee/data/data-mapping/data-item-linking/',
	...
	return [
		{
			name: 'json',
			returnType: 'Object',
			docURL: 'http://newflow.ee/data/data-structure/',
