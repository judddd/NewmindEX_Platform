...
import { updateNpsSurveyState } from '@newflow/rest-api-client/api/npsSurvey';
import type { N8nPrompts } from '@newflow/rest-api-client/api/prompts';
import { getPromptsData } from '@newflow/rest-api-client/api/prompts';
