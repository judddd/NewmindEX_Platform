...
import type { ChatUI } from '@newflow/design-system/types/assistant';
...
describe('AI Assistant store', () => {
	...
	it('should not show assistant if on a settings page', () => {
		// NewFlow: SSO removed - use alternative route for test
		currentRouteName = VIEWS.PERSONAL_SETTINGS;
		const assistantStore = useAssistantStore();
