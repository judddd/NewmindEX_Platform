...
// NewFlow: Log Streaming feature removed - stub store for compatibility
...
export const useLogStreamingStore = defineStore('logStreaming', () => {
	// NewFlow: All Log Streaming functionality removed - returning empty/stub implementations
	...
	// NewFlow: All async operations throw error - feature removed
	const saveDestination = async (
		_destination: MessageEventBusDestinationOptions,
	): Promise<boolean> => {
		throw new Error('Log Streaming feature has been removed');
	};
	...
	const deleteDestination = async (_destinationId: string) => {
		throw new Error('Log Streaming feature has been removed');
	};
