...
import * as versionsApi from '@newflow/rest-api-client/api/versions';
import type { IVersionNotificationSettings } from '@newflow/api-types';
import type {
	Version,
	WhatsNewArticle,
	WhatsNewSection,
} from '@newflow/rest-api-client/api/versions';
...
const currentVersion: Version = {
	...
	documentationUrl: 'http://newflow.ee',
	...
	describe('checkForNewVersions()', () => {
		...
		it("should still initialize versions if what's new articles fail", async () => {
			...
			versionsStore.initialize({
				...
				infoUrl: 'http://newflow.ee/hosting/installation/updating/',
			});
