...
import * as eventsApi from '@newflow/rest-api-client/api/events';
import * as settingsApi from '@newflow/rest-api-client/api/settings';
import * as moduleSettingsApi from '@newflow/rest-api-client/api/module-settings';
import { testHealthEndpoint } from '@newflow/rest-api-client/api/templates';
...
export const useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	// NewFlow: Auto-setup mode for appliance deployments
	const isAutoSetupMode = computed(() => settings.value.autoSetup?.enabled ?? false);
