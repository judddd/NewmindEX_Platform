...
import type { LoginRequestDto } from '@newflow/api-types';
...
<template>
	<div>
		...
		>
			<!-- NewFlow Cloud: Add registration link -->
			<template #footer>
				<div :class="$style.signupLink">
					<N8nText size="small" color="text-base">
						{{ locale.baseText('auth.noAccount') }}
						<N8nLink :to="{ name: VIEWS.SETUP }">
							{{ locale.baseText('auth.register') }}
						</N8nLink>
					</N8nText>
				</div>
			</template>
