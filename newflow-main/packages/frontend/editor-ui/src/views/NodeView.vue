...
import type { IWorkflowTemplate } from '@newflow/rest-api-client/api/templates';
...
import { useExternalSecretsStore } from '@/stores/externalSecrets.store';
...
import CanvasThinkingPill from '@newflow/design-system/components/CanvasThinkingPill/CanvasThinkingPill.vue';
...
import { useAgentRequestStore } from '@newflow/stores/useAgentRequestStore';
...
async function initializeRoute(force = false) {
	...
	// NewFlow: Evaluation actions removed
...
// NewFlow: Evaluation code removed
...
watch(
	...
	(isReadOnlyOrLoading) => {
		...
		fallbackNodes.value = [addNodesItem];
	},
);
