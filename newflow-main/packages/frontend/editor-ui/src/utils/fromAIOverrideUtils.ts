...
const NODE_DENYLIST = [
	'@newflow/n8n-nodes-langchain.toolCode',
	'@newflow/n8n-nodes-langchain.toolHttpRequest',
	'@newflow/n8n-nodes-langchain.mcpClientTool',
	['@newflow/n8n-nodes-langchain.toolWorkflow', 1.2],
] as const;
