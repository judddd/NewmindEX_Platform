...
export const PLAYGROUND_1: WorkflowDataCreate = {
	...
	nodes: [
		...
		},
		{
			parameters: {
				content:
					'**Tip: Resources**\n- Use the AI Assistant or any LLM like `ChatGPT` to explain a screenshot, fix issues, or create workflows for you\n- Learn and get inspired with [templates](http://newflow.ee/workflows/)\n- Follow the [courses](http://newflow.ee/courses/) or find tutorials on Youtube\n- Check the documentation for help\n',
				height: 176,
				width: 400,
				color: 5,
			},
