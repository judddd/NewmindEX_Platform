...
import type { WorkflowDataCreate } from '@newflow/rest-api-client';
...
export const AGENT_WITH_TOOLS: WorkflowDataCreate = {
	...
	nodes: [
		...
		{
			parameters: {},
			type: '@newflow/n8n-nodes-langchain.memoryBufferWindow',
			typeVersion: 1.3,
			position: [208, 288],
		...
		{
			parameters: {},
			type: '@newflow/n8n-nodes-langchain.toolCalculator',
			typeVersion: 1,
			position: [624, 288],
