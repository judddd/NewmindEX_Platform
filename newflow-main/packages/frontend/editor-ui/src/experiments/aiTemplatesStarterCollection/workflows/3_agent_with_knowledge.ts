...
export const AGENT_WITH_KNOWLEDGE: WorkflowDataCreate = {
	...
	nodes: [
		...
		},
		{
			...
			type: '@newflow/n8n-nodes-langchain.embeddingsOpenAi',
			typeVersion: 1.2,
			position: [288, 176],
		...
		},
		{
			...
			type: '@newflow/n8n-nodes-langchain.documentDefaultDataLoader',
			typeVersion: 1.1,
			position: [80, -144],
		...
		},
		{
			...
			type: '@newflow/n8n-nodes-langchain.vectorStoreInMemory',
			typeVersion: 1.2,
			position: [-176, -304],
