...
import type { ITemplatesWorkflowFull } from '@newflow/rest-api-client';
...
const PREDEFINED_TEMPLATES_BY_NODE = {
	...
	'@newflow/n8n-nodes-langchain.openAi': [2462, 2722, 2178],
	'@newflow/n8n-nodes-langchain.googleGemini': [5993, 6270, 5677],
