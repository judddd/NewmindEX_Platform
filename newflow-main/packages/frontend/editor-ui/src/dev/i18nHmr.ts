...
import { i18n, i18nInstance, setLanguage, updateLocaleMessages } from '@newflow/i18n';
import type { LocaleMessages } from '@newflow/i18n/types';
import { locale as designLocale } from '@newflow/design-system';
...
if (hot) {
	...
	const localeModules = import.meta.glob('@newflow/i18n/locales/*.json', { eager: true }) as Record<
		string,
