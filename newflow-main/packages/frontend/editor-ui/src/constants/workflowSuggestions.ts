...
export const WORKFLOW_SUGGESTIONS: WorkflowSuggestion[] = [
	{
		...
		prompt:
			'Create an invoice parsing workflow using NewFlow forms. Extract key information (vendor, date, amount, line items) using AI, validate the data, and store structured information in Airtable. Generate a weekly spending report every Sunday at 6 PM using AI analysis and send via email.',
	},
	{
		id: 'ai-news-digest',
	...
	},
	{
		...
		prompt:
			'Build a pipeline that accepts PDF, CSV, or JSON files through a NewFlow form. Chunk documents into 1000-token segments, generate embeddings, and store in a vector database. Use the filename as the document key and add metadata including upload date and file type. Include a chatbot that can answer questions based on a knowledge base.',
	},
	{
		id: 'email-summary',
